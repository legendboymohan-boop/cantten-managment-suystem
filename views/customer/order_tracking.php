...
<main class="container narrow">
    ...
    <?php if ($order['status'] !== 'cancelled'): ?>
        <div class="card review-form-card">
            ...
            <p class="muted"><?= $order['status'] === 'completed' ? 'Rate the waiter and Chef who handled this order, or skip the review.' : 'You can rate the waiter and Chef who handled this order after payment, or skip the review.' ?></p>
